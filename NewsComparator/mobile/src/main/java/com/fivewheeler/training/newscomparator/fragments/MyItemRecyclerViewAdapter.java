...
import com.fivewheeler.training.newscomparator.fragments.BaseFragment.OnListFragmentInteractionListener;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mTitleView.setText(Html.fromHtml(mValues.get(position).title));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mUrlView = (TextView) view.findViewById(R.id.linkUrl);
        }

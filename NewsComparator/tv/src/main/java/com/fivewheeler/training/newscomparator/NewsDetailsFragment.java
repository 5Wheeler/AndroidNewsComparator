...
public class NewsDetailsFragment extends DetailsFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedMovie = (Movie) getActivity().getIntent()
                .getSerializableExtra(NewsDetailsActivity.MOVIE);
        if (mSelectedMovie != null) {
            ...
            Intent intent = new Intent(getActivity(), NewsDashboard.class);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(NewsDetailsActivity.MOVIE, mSelectedMovie);
                    startActivity(intent);
                } else {
